...
if __name__ == '__main__':
    ...
    for n in args.n:
        ...
        # create log file
        log_path = args.record + '/log-dim-' + str(n) + '.txt'
        result_path = args.record + '/result-dim-' + str(n) + '.txt'
        graph_path = args.record + '/graph-dim-' + str(n) + '.png'
        curve_path = args.record + '/curve-dim-' + str(n) + '.png'
