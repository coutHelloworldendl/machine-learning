...
parser.add_argument('--n'          , type = list[int]   , default = [12]   )
...
parser.add_argument('--nu'         , type = float , default = 1000         ) 
...
parser.add_argument('--load_lattice'  , type = bool  , default = False       )
...
parser.add_argument('--epoch'          , type = int   , default = 30000000 // args.batch_size )
args = parser.parse_args()
